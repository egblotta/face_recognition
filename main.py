...
imagen_emiliano = face_recognition.load_image_file("img_test2.jpg")
imagen_fer = face_recognition.load_image_file("fernando.jpg")
imagen_emma = face_recognition.load_image_file("emma.jpg")
imagen_gabriel = face_recognition.load_image_file("gabriel.jpg")
...
emiliano_encodings = face_recognition.face_encodings(imagen_emiliano)[0]
fer_encodings = face_recognition.face_encodings(imagen_fer)[0]
emma_encodings = face_recognition.face_encodings(imagen_emma)[0]
gabriel_encodings = face_recognition.face_encodings(imagen_gabriel)[0]
...
img = face_recognition.load_image_file('img_test4.jpg')
